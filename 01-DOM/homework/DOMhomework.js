...
spam.innerHTML = 'Aplicación creada por: Luis Hernan'
...
function buildToDos(toDos) {
  // Tu código acá:
  let newArrayToDosDiv = toDos.map(buildToDo);

  return newArrayToDosDiv;
...
function displayToDos() {
  ...
  arrayDivs.forEach(function(toDoDiv, indice){
